...
from Thesis.policies import DQNPolicy
...
class DQN(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
        ...
        super(DQN, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose, requires_vec_env=False,
                                  policy_kwargs=policy_kwargs, seed=seed, n_cpu_tf_sess=n_cpu_tf_sess)
